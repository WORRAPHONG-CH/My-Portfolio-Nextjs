...
const BackgroundGrid = ({
    ...
    fade = true,
    ...props
}: Partial<BackgroundGridProps> & React.HTMLProps<HTMLDivElement>) => {
    const svg = `
    ...
    return (
        <div className={`pointer-events-none absolute inset-0 left-0 top-5 flex h-full w-full ${className}`}
        style={{
